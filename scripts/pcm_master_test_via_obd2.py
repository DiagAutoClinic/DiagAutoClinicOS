...
- Protocols: UDS, KWP2000, CAN, ISO15765
...
class PCMMasterTester:
    ...
    def __init__(self, mock_mode: bool = True):
        ...
        self.pcm_config = {
            ...
            'supported_protocols': ['UDS', 'KWP2000', 'CAN', 'ISO15765'],
    ...
    def initialize_test_environment(self) -> bool:
        ...
        try:
            ...
            # Connect to PCMmaster
            if not self.device_handler.connect_to_device("PCMmaster", "UDS"):
    ...
    def test_pcm_identification(self) -> Dict:
        ...
        try:
            ...
            protocol_tests = {
                'UDS_supported': 'UDS' in self.pcm_config['supported_protocols'],
                'KWP2000_supported': 'KWP2000' in self.pcm_config['supported_protocols'],
            ...
            print(f"  Protocol Support: {sum(protocol_tests.values())}/4")
...
def main():
    ...
    print(f"\n📄 Test report saved to: {txt_file}")
    print(f"📊 JSON results saved to: {json_file}")
    
    # Return appropriate exit code
    if results['overall_status'] == 'SUCCESS':
        print("\n✅ PCM Master Test completed successfully!")
        return 0
    elif results['overall_status'] == 'PARTIAL_SUCCESS':
        print("\n⚠️  PCM Master Test completed with warnings!")
        return 1
    else:
        print("\n❌ PCM Master Test failed!")
        return 2
