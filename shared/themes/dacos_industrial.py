"""
DACOS Industrial Theme
"Workshop Professional" - High Contrast Amber
Location: shared/themes/dacos_industrial.py
"""
...
# ===== DACOS INDUSTRIAL PALETTE =====
DACOS_THEME = {
    "bg_main": "#1e1e1e",      # Dark Grey (VS Code like)
    "bg_panel": "#252526",     # Slightly lighter panel
    "bg_card": "#2d2d30",      # Card Background
    "accent": "#ff9900",       # Industrial Amber
    "accent_hover": "#ffb347", # Lighter Amber
    "glow": "#ffcc00",         # Glow
    "text_main": "#eeeeee",    # Off-White
    "text_muted": "#aaaaaa",   # Grey Text
    "border": "#3e3e42",       # Subtle Border
    "border_active": "#ff9900",# Active Border
...
DACOS_STYLESHEET = f"""
/* =====================================================================
   DACOS Modern Layout - Industrial Professional
...
def apply_theme(app):
    try:
        ...
        logger.info("DACOS Industrial Theme applied")
        return True
    except Exception as e:
        logger.error(f"Failed to apply DACOS Industrial Theme: {e}")
        return False
