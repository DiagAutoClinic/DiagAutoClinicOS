"""
DACOS Claude Themes
Location: shared/themes/dacos_claude.py
"""
...
# ===== DACOS CLAUDE PALETTE (Teal Fusion) =====
DACOS_THEME = {
    "bg_main": "#0A1A1A",
    "bg_panel": "#0D2323",
    "bg_card": "#134F4A",
...
DACOS_STYLESHEET = f"""
/* =====================================================================
   DACOS Modern Layout - Claude Teal Fusion
...
QLineEdit:focus, QTextEdit:focus, QPlainTextEdit:focus, QSpinBox:focus, QComboBox:focus {{
    border: 1px solid {DACOS_THEME['accent']};
    background-color: rgba(33, 245, 193, 0.05);
}}
...
def apply_theme(app):
    try:
        ...
        logger.info("DACOS Claude Theme applied")
        return True
    except Exception as e:
        logger.error(f"Failed to apply DACOS Claude Theme: {e}")
        return False
