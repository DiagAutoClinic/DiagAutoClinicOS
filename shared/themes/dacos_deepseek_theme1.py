"""
DACOS Neon Professional
Primary production theme with professional gradients
"""
import logging
...
DACOS_THEME = {
    "bg_main": "#0A1A1A",
    "bg_panel": "rgba(13, 35, 35, 0.9)",
    "bg_card": "rgba(19, 79, 74, 0.7)",
    "accent": "#21F5C1",
    "accent_hover": "#2AF5D1",
    "glow": "#21F5C1",
    "text_main": "#E8F4F2",
    "text_muted": "#9ED9CF",
    "border": "rgba(33, 245, 193, 0.3)",
...
DACOS_STYLESHEET = f"""
/* =====================================================================
   DACOS Modern Layout - Adapted for Neon Professional
   ===================================================================== */
...
/* ===== BUTTONS ===== */
QPushButton {{
    background-color: rgba(33, 245, 193, 0.1);
...
QPushButton:hover {{
    background-color: rgba(33, 245, 193, 0.2);
...
def apply_theme(app):
    try:
        ...
        logger.info("DACOS Neon Professional (Modern Layout) applied")
        return True
